...
<div class="container">
			  <ul class="list-inline">
			    <li><a href="addlocation.php" class="btn btn-info">Location</a></li>
			  </ul>
			</div>
			...
			<div class="col-md-6 col-sm-6 col-xs-6 part1" style="background-color: #B7E4EB; border: 2px solid #0FA4BB; padding: 25px; border-radius: 8px; ">
				<h3 class="center">View Location</h3> <br>
					...
					<?php include('con_db.php');
						...
						while($fetch=mysql_fetch_array($qr))
						{
							...
							<tr>
								...
								<td><a href="uplocation.php?loc=<?php echo $fetch['loc_id']; ?>" onclick="return updateit();"  class="btn btn-success"><i class="fa fa-edit"></i></a> <a href="dellocation.php?loc=<?php echo $fetch['loc_id']; ?>" onclick="return deleteit();" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
							</tr>
					<?php		
						}
					 ?>

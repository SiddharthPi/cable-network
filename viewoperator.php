	...
	<div class="container w3ls-service" id="service">
		...
		<div class="container">
			  <ul class="list-inline">
			    <li><a href="addoperator.php" class="btn btn-info">Add Operator</a></li>
			  </ul>
			</div>
			...
			<div class="col-md-6 col-sm-6 col-xs-6 part1" style="background-color: #B7E4EB; border: 2px solid #0FA4BB; padding: 25px; border-radius: 8px; ">
				<h3 class="center">View Operator</h3> <br>
					...
					<?php include('con_db.php');
						...
						while($fetch=mysql_fetch_array($qr))
						{
							...
							<tr>
					        	...
					        	<td><?php echo $fetch['contact1']; ?></td>
					        	<td><?php echo $fetch['salary']; ?></td>
								<td><?php echo $fetch['email'];?> </td>
								<td><a href="upoperator.php?op=<?php echo $fetch['op_id']; ?>" onclick="return updateit();"  class="btn btn-success"><i class="fa fa-edit"></i></a> <a href="deloperator.php?op=<?php echo $fetch['op_id']; ?>" onclick="return deleteit();"   class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
							</tr>
					<?php		
						}
					 ?>

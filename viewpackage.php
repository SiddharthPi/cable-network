	...
	<div class="container w3ls-service" id="service">
		...
		<div class="container">
			...
			<div class="col-md-6 col-sm-6 col-xs-6 part1" style="background-color: #B7E4EB; border: 2px solid #0FA4BB; padding: 25px; border-radius: 8px; ">
				<h3 class="center">View Package</h3> <br>
					...
					<?php include('con_db.php');
						...
						while($fetch=mysql_fetch_array($qr))
						{
					        ...
					        <td><?php echo $fetch['validity']; ?></td>
							    <td><a href="uppackage.php?pack=<?php echo $fetch['p_id']; ?>" onclick="return updateit();"  class="btn btn-success"><i class="fa fa-edit"></i></a> <a href="delpackage.php?pack=<?php echo $fetch['p_id']; ?>" onclick="return deleteit()" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
							</tr>
					<?php		
						}
					 ?>

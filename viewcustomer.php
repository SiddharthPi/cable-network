		...
		<div class="row-agile">
			<div class="container">
			  <ul class="list-inline">
			    <li><a href="viewrequest.php" class="btn btn-info">View  Request</a></li>
			  </ul>
			</div>
			...
			<div class="col-md-8 col-sm-8 col-xs-8 part1" style="background-color: #B7E4EB; border: 2px solid #0FA4BB; padding: 25px; border-radius: 8px; ">
				<h3 class="center">View Customers</h3> <br>
				...
				if(isset($_POST['Search']))
				{
						...
						$qr=mysql_query("select * from user where location='$loc'") or die(mysql_error());
				...
				<?php } else {
				 ?>
				 <div style="text-align: center; color: orange; font-size: 30px;">Data Not Found</div>
				 <?php }  } ?>

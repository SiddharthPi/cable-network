	...
	<div class="container w3ls-service" id="service">
		...
		<div class="container">
			  <ul class="list-inline">
			    <li><a href="addchannel.php" class="btn btn-info">Add Channel</a></li>
			  </ul>
			</div>
			...
			<div class="col-md-8 col-sm-8 col-xs-8 part1" style="background-color: #B7E4EB; border: 2px solid #0FA4BB; padding: 25px; border-radius: 8px; ">
				<h3 class="center">View Channels</h3> <br>
				<table class="table table-bordered table-striped table-hover" style="background-color: #fff;"">
					...
					<?php include('con_db.php');
						$a=1;
						$qr=mysql_query("select * from channel,package where package.p_id=channel.p_id") or die(mysql_error());
						while($fetch=mysql_fetch_array($qr))
						{
							...
							<tr>
								...
								<td><a href="upchannel.php?chn=<?php echo $fetch['ch_id']; ?>&&pid=<?php echo $fetch['p_id']; ?>"  onclick="return updateit();" class="btn btn-success"><i class="fa fa-edit"></i></a> <a href="delchannel.php?chn=<?php echo $fetch['ch_id']; ?>"  onclick="return deleteit();" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
							</tr>
					<?php		
						}
					 ?>
